...
const ProfileImage = memo(({ photo, name }) => (
...
const TeamSection = memo(({ member, index }) => (
  <div
      ...
      <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
            <a href={member.cvLink} className="w-full lg:w-auto">
              <button
                data-aos="fade-up"
                data-aos-duration="800"
            ...
            <a href="#" className="w-full lg:w-auto">
              ...
              >
                <Code className="w-4 h-4 sm:w-5 sm:h-5" /> View Profile
              </button>
            </a>
          </div>
        </div>

        <ProfileImage photo={member.photo} name={member.name} />
      </div>
  ...
  return (
    <>
      ...
      {teamData.map((member, index) => (
        <TeamSection key={member.id} member={member} index={index} />
      ))}
    </>
  )
}
