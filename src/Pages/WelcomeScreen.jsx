...
const BackgroundEffect = () => (
  <div className="absolute inset-0 overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-r from-sky-500/20 to-indigo-500/20 blur-3xl animate-pulse" />
    <div className="absolute inset-0 bg-gradient-to-tr from-sky-500/10 via-transparent to-indigo-500/10 blur-2xl animate-float" />
  </div>
);

const IconButton = ({ Icon }) => (
  <div className="relative group hover:scale-110 transition-transform duration-300">
    <div className="absolute -inset-2 bg-gradient-to-r from-sky-500 to-indigo-400 rounded-full blur opacity-30 group-hover:opacity-75 transition duration-300" />
...
const WelcomeScreen = ({ onLoadingComplete }) => {
  ...
  return (
    <AnimatePresence>
      {isLoading && (
        <motion.div
          className="fixed inset-0 bg-[#0B0F1A]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit="exit"
              ...
              >
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  <div className="mb-2 sm:mb-4">
                    ...
                    <span data-aos="fade-right" data-aos-delay="400" className="inline-block px-2 bg-gradient-to-r from-white via-sky-100 to-blue-200 bg-clip-text text-transparent">
                      To
                    </span>{' '}
